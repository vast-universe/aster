...
// API 配置
export const API_URL = process.env.ASTER_API_URL || "https://aster.dev";
...
// 文件名
export const CONFIG_FILE = "aster.json";
export const CREDENTIALS_FILE = "credentials.json";
export const TRANSACTION_FILE = ".transaction.json";

// 目录
export const ASTER_DIR = ".aster";
export const CREDENTIALS_DIR = ".aster";
