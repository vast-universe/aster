...
const TEMPLATE_PACKAGE_JSON = (name: string) => ({
  ...
  scripts: {
    build: "npx aster registry build",
    "publish:registry": "npx aster registry publish",
  },
  devDependencies: {
    typescript: "^5.0.0",
  },
 ...
 * Aster Registry 配置
 * 文档: https://aster.dev/docs/registry
 */
export default {
  // 你的命名空间 (需要先在 aster.dev 注册)
  namespace: "${namespace}",
...
- [Aster 文档](https://aster.dev/docs)
- [创建组件指南](https://aster.dev/docs/registry)
`;
